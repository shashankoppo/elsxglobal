      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            ...
            className="h-12 px-7 text-base bg-primary hover:bg-primary/90 group glow-primary"
          >
          ...
          <Button
            ...
            className="h-12 px-7 text-base border-border/60 bg-card/30 backdrop-blur-sm hover:bg-card/60"
          >
            Request a Proposal
          </Button>
        </div>
