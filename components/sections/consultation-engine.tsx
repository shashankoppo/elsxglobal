      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title={
            <>
              ...
              <br />
              of <span className="text-gradient-primary">Your Organization?</span>
            </>
          }
        ...
        <div className="mt-16 grid lg:grid-cols-2 gap-8">
          <div>
            ...
            <div className="mt-6 glass-strong rounded-xl p-4 flex items-center gap-3">
            ...
            <div className="space-y-2 mb-5">
              {SLOTS[selectedDay].times.map((t) => (
                <button
                  ...
                  className={cn(
                    'w-full rounded-lg border px-4 py-2.5 text-sm font-medium transition-all flex items-center justify-between',
                    selectedSlot === t
                      ? 'border-primary bg-primary/10 text-primary'
                      : 'border-border/60 bg-background/40 hover:border-primary/40 text-foreground'
                  )}
                >
                  <span>{t}</span>
                  {selectedSlot === t && (
            ...
            <div className="mt-5 pt-5 border-t border-border/40">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <Button
                  ...
                  className="text-xs h-9"
                >
                  <a href="mailto:hello@elsxglobal.com">
