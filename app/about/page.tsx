  ...
  return (
    <>
      <PageHero
        ...
        description="ELSxGlobal is a division of EvolucentSphere Pvt. Ltd., founded on the conviction that technology should be the engine of growth — not its bottleneck. We help organizations build digital foundations that make them faster, smarter, safer, and infinitely scalable."
      />
